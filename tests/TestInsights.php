...
class TestInsights extends TestCase
{
    ...
    {
        //Get Intellect
        $intellect = $this->app->make('PersonalityInsights')->addContentItems($this->contentItems)->getInsight('Intellect');
    ...
    {
        //Analysis is strong
        $this->assertTrue($this->app->make('PersonalityInsights')->addContentItems($this->contentItems)->isAnalysisStrong());
    }
